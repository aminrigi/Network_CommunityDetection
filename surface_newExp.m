function [precision, recall, F1 ] = surface_newExp(changeLog, net, nodes)
        ...
        switch operation_id(i)
            ...
            case -1 %node_addition
                if (addedNode_counter > 1)
                    ...
                    sw = -1;
                    if (afterTension(community_id) < prevTension(community_id)) || (  prevTension(community_id) - afterTension(community_id) < 2   )
                        sw = 1;
